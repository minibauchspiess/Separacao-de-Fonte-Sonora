...
files = {'Cb-ord-B4-pp-1c.wav' 'Cb-ord-B4-mf-1c.wav' 'Cb-ord-B4-ff-1c.wav' 'Fl-ord-B4-pp.wav' 'Fl-ord-B4-mf.wav' 'Fl-ord-B4-ff.wav'};    %Arquivos a serem utilizados na entrada da rede
targets = {outCb outCb outCb outFl outFl outFl};    %Qual a saída desejada da rede, considerando a ordem dos arquivos em "files"

winPerAudio = 40;  %Quantas amostras serão extraídas de cada áudio
